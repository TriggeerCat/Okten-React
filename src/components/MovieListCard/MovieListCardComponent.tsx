...
export const MovieListCardComponent: FC<PropsType> = ({movie}) => {
    return (
        <Link to={'info/' + movie.id} className='p-2 w-1/10 hover:bg-neutral-700 rounded-2xl flex flex-col justify-between'>
            ...
            <div className='flex justify-between w-full mt-2 align-bottom'>
